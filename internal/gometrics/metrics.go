...
func init() {
	prometheus.MustRegister(gauge, obs, obsResponseSize, obsRequestSize)
}
...
func StartManagementServer(listenAddress, endPoint string, healthCheckFunc func(http.ResponseWriter, *http.Request)) (managementServer *ManagementServer) {
	mux := http.NewServeMux()
	mux.Handle(endPoint, GetMetricsHandler())
